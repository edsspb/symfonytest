...
(function(window, angular){
    ...
    var angularHashModule = angular.module('angularHashModule', []);

    angularHashModule.factory('angularHash', [function () {
        var algorithms = {
            djb2: function (str) {
                var hash = 5381,
                    char;
        ...
        var angularHash = {
            hash: function(object, algorithm) {
                var hashs = [];
                ...
                for (var key in object) {
                    ...
                    if (typeof(val) == "object") {
                        val = angularHash.hash(object[key], algorithm);
                    }
