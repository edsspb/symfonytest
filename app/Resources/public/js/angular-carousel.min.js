...
(function() {
    ...
    angular.module('angular-carousel')
        ...
        .directive('rnCarousel', ['$swipe', '$window', '$document', '$parse', '$compile', 'caruselAdapter',
            function($swipe, $window, $document, $parse, $compile, caruselAdapter) {
            ...
            return {
                ...
                compile: function(tElement, tAttributes) {
                    ...
                    if (typeof tElement.attr('rn-carousel-control') != 'undefined') {
                        var isCallback = true;
                    }
                    ...
                    return function(scope, iElement, iAttributes, containerCtrl) {
                        ...
                        function newSlideEvent() {
                            if (isCallback) {
                                caruselAdapter.compare(scope.carouselIndex);
                            };
                        }
                        ...
                        function swipeEnd(coords, event, forceAnimation) {
                            ...
                            requestAnimationFrame(autoScroll);
                            if (!isNaN(slidesMove) && (slidesMove == -0)) {
                                newSlideEvent();
                            }
                            return false;
                        }
