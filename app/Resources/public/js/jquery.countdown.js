...
(function( $ ) {
    var init = function( userOptions ) { 
        ...
        var createDigits = function(where) {
            ...
            for (var i = 0; i < options.startTime.length; i++) {
                ...
                if (parseInt(options.startTime[i]) >= 0) {
                    ...
                    var style = 'style="height: '+options.digitHeight * options.digitImages * 10+'px; background: url(\'' + options.image + '\'); width: '+options.digitWidth+'px;"';    
                    var elem = jQuery('<div class="cntDigit-container" style="width: '+options.digitWidth+'px; height: '+options.digitHeight * options.digitImages * 10+'px; float: left;"><div class="background" style="position: absolute;"></div><div id="cnt_' + i + '" '+style+' class="cntDigit" ></div></div>');
        ...
        this.css({height: (options.digitHeight + options.additionalHThis), overflow: 'hidden'});
        createDigits(this);
